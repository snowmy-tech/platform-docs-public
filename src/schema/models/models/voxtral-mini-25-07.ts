...
export default {
  ...
  pricing: {
    ...
    free: false,
    input: [
      { type: 'range', price: 0.001, priceEur: 0.00088, denominator: '/Min' },
      { type: 'flat', price: 0.04, priceEur: 0.03, denominator: '/M Tokens' }
    ],
    output: [
      { type: 'range', price: 0.04, priceEur: 0.04, denominator: '/M Tokens' }
    ]
  },
