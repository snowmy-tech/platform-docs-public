...
**A.** Via Studio :
  - Envoyez vos fichiers dans <AppLink href="https://console.snowmy.app/build/files" app="studio">Fichiers</AppLink>.
    - Envoyez le fichier au format décrit précédemment.
    - Définissez `purpose` sur Batch Processing.
  - Lancez et gérez vos lots dans <AppLink href="https://console.snowmy.app/build/batches" app="studio">Lots</AppLink>.
