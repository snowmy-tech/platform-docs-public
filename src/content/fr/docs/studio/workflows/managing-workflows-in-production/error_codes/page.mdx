...
**Résolution :** Vérifiez l'ID d'exécution. Consultez le [tableau de bord Workflows](https://console.snowmy.app/build/workflows) pour obtenir l'ID correct.
...
**Résolution :** Vérifiez la connectivité streaming. Consultez [Streaming](/studio/workflows/building-workflows/streaming) pour les détails de configuration.
