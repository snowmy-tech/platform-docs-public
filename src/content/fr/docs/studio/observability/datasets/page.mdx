...
Importez des conversations depuis le [Playground](https://console.snowmy.app/build/playground) — utile si vous avez testé des agents ou des prompts et souhaitez réutiliser ces conversations sans les recréer manuellement.
