...
Ou lancez-le depuis la [Console Mistral](https://console.snowmy.app) :
...
<UsefullLinkContainer>
  <LinkCard href="/studio/workflows/getting-started/core_concepts" title="Concepts fondamentaux" />
  <LinkCard href="/studio/workflows/getting-started/cookbook_examples" title="Exemples d'utilisation" />
  <LinkCard href="/studio/workflows/building-workflows/durable_agents" title="Créer un agent durable" />
