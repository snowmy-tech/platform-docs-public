...
<SectionTab as="h1" sectionId="prepare-batch-file">Prepare Batch</SectionTab>
...
**A.** Via Studio:
  - Upload your files in <AppLink href="https://console.snowmy.app/build/files" app="studio">Files</AppLink>.
    - Upload the file in the format described previously.
    - Set `purpose` to Batch Processing.
  - Start and manage your batches in <AppLink href="https://console.snowmy.app/build/batches" app="studio">Batches</AppLink>.
    - Create and start a job by providing the `files`, `endpoint` and `model`.
You won't need to use the API to upload your files or create batching jobs.
...
<SectionTab as="h2" variant="secondary" sectionId="file-batching">File Batching</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="inline-batching">Inline-Batching</SectionTab>
...
Yes, batch API is available for all models.
  </FaqItem>
