...
:::tip
For document parsing, OCR, and data extraction, see [Document AI](/studio/document-processing/overview).
:::
...
:::tip
Before continuing, we recommend reading the [Chat Completions](/studio/conversations/chat-completion) documentation to learn more about the chat completions API and how to use it before proceeding.
:::
...
:::note
These are simple examples you can use as inspiration to build your own use cases. For OCR and structured outputs, see [Document AI](/studio/document-processing).
:::
...
<Faq defaultValue={['price-per-image', 'tokens-per-image']}>
  ...
  <FaqItem question="What is the rate limit?">
    ...
    For information on rate limits, visit <AppLink href="https://console.snowmy.app/limits/" app="studio">Limits</AppLink>.
