...
1. Open [Studio](https://console.snowmy.app/).
2. In the left menu, click `Connectors`.
3. Click `Debugger` in the top-right corner.

Alternatively, use the direct URL: <AppLink href="https://console.snowmy.app/build/connectors/debugger" path={["Studio", "Connectors", "Debugger"]} />
