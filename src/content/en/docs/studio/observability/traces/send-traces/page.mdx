...
This page covers how to instrument each supported data source so it sends [OpenTelemetry](https://opentelemetry.io/) traces to Mistral. After traces are flowing, you can explore them in the [Trace Explorer](https://console.snowmy.app/observability/traces).
...
:::
  ...
  <ExplorerTab value="vibe-work" label="Vibe Work and Vibe Code Web">
...
After enabling instrumentation, make one or more requests through your application, then open the [Trace Explorer](https://console.snowmy.app/observability/traces) in Studio. Traces typically appear within a few seconds.
