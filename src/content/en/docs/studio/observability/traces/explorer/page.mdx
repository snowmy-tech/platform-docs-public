...
The Trace Explorer is where you search, filter, and inspect every trace flowing through your AI applications. It's available in Studio at [Observability → Traces](https://console.snowmy.app/observability/traces).
