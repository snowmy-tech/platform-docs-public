...
Or trigger it from the [Mistral Console](https://console.snowmy.app):
...
<UsefullLinkContainer>
  <LinkCard href="/studio/workflows/getting-started/core_concepts" title="Core concepts" />
  <LinkCard href="/studio/workflows/getting-started/cookbook_examples" title="Cookbook examples" />
  <LinkCard href="/studio/workflows/building-workflows/durable_agents" title="Build a durable agent" />
