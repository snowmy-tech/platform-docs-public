...
Use the <AppLink href="https://console.snowmy.app" app="studio">Studio</AppLink> playground to send prompts to Mistral models, adjust generation parameters, and compare outputs, all without writing code.
...
1. Go to <AppLink href="https://console.snowmy.app" app="studio">Studio</AppLink>.
