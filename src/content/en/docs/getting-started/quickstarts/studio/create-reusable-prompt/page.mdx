...
Use <AppLink href="https://console.snowmy.app/build/prompts" app="studio">Prompts</AppLink> to save prompt templates you can reuse privately or share with your workspace in Studio and in applications that reference shared prompt definitions.
...
1. Open <AppLink href="https://console.snowmy.app" app="studio">Studio</AppLink>.
...
<UsefullLinkContainer>
  ...
  <LinkCard href="/inference/prompting" title="Prompt engineering guide" />
</UsefullLinkContainer>
