...
Use <AppLink href="https://console.snowmy.app/build/skills" app="studio">Skills</AppLink> to package a reusable method, checklist, or procedure that an AI assistant can apply when a task matches.
...
<UsefullLinkContainer>
  ...
  <LinkCard href="/studio/agents/introduction" title="Agents overview" />
