...
- **Legal clause checker**: upload a contract and ask the Agent to flag non-standard clauses based on your internal policy [Library](/vibe/work/libraries).
...
- **Technical FAQ**: attach your product documentation as a [Library](/vibe/work/libraries) and share the Agent with your team so anyone can get accurate, sourced answers.
- **Translation with context**: an Agent that translates content while respecting your glossary and brand terminology, attached as a [Library](/vibe/work/libraries).

<SectionTab as="h2" sectionId="creating-an-agent">Creating an Agent</SectionTab>
...
4. Configure the Agent (see [next section](#configuration)).
...
- **[Web search](/vibe/work/web-search-open-url)**: retrieve current information from the web.
- **[Code Interpreter](/vibe/chat-legacy/code-interpreter)**: run Python for calculations, data analysis, and charts.
- **[Canvas](/vibe/work/files-and-canvas)**: generate and edit documents, code, spreadsheets, or presentations.
- **[Image generation](/vibe/work/image-generation)**: create images from text descriptions.

**Knowledge**

- **[Libraries](/vibe/work/libraries)**: attach one or more Libraries to give the Agent access to your uploaded documents.
- **[Connectors](/vibe/work/connectors)**: attach Connectors to pull data from external services like Google Drive, GitHub, or Notion.

</ExplorerTab>
</ExplorerTabs>

<SectionTab as="h2" sectionId="using-agents">Using Agents in Chat</SectionTab>

<SectionTab as="h3" variant="secondary" sectionId="starting-conversation">Starting a conversation with an Agent</SectionTab>
...
<SectionTab as="h3" variant="secondary" sectionId="switching-agents">Switching Agents</SectionTab>
...
<SectionTab as="h3" variant="secondary" sectionId="returning-default-model">Returning to the default model</SectionTab>
...
<SectionTab as="h2" sectionId="writing-instructions">Writing effective instructions</SectionTab>
...
:::info
For a broader introduction to prompt writing techniques, see our [prompt engineering guide](/inference/prompting).
:::

<SectionTab as="h2" sectionId="sharing">Sharing and permissions</SectionTab>

By default, a new Agent is **private** (only you can see and use it).

<SectionTab as="h3" variant="secondary" sectionId="sharing-specific-people">Sharing with specific people</SectionTab>
...
<SectionTab as="h3" variant="secondary" sectionId="sharing-organization">Sharing with your entire organization</SectionTab>
...
<SectionTab as="h2" sectionId="managing-agents">Managing Agents</SectionTab>

<SectionTab as="h3" variant="secondary" sectionId="duplicating-agent">Duplicating an Agent</SectionTab>
...
<SectionTab as="h3" variant="secondary" sectionId="deleting-agent">Deleting an Agent</SectionTab>
...
<SectionTab as="h2" sectionId="agents-and-api">Agents and the API</SectionTab>

Agents created in Chat are designed for the chat interface and can't be used programmatically. If you need API access, create Agents through <AppLink href="https://console.snowmy.app/build/agents" app="studio">Agents</AppLink> or the [REST API](https://docs.mistral.ai/api/#tag/beta.agents).
...
- **[Skills](/vibe/work/skills)**: the Vibe Work successor for reusable, specialized behavior.
- **[Custom instructions](/vibe/work/custom-instructions)**: set persistent behavior rules that apply to all conversations (Agents override these when active).
- **[Libraries](/vibe/work/libraries)**: build knowledge bases from uploaded documents to attach to your Agents.
- **[Connectors](/vibe/work/connectors)**: connect external data sources like Google Drive, GitHub, or Notion.
- **[Files and Canvas](/vibe/work/files-and-canvas)**: create and edit content collaboratively with AI.
- **[Code Interpreter](/vibe/chat-legacy/code-interpreter)**: run Python for data analysis and visualization.
- **[Projects](/vibe/work/projects)**: organize conversations into scoped work areas.
