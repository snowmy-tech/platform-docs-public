...
May 27, 2025
- We released the new [Agents API](/studio/agents/introduction).

May 22, 2025
- We released Mistral OCR 2505 (`mistral-ocr-2505`) and [annotations](/studio/data-ingestion/document-intelligence/annotations).
...
April 16, 2025
- We released the [Classifier Factory](/resources/deprecated/finetuning/classifier_factory).

March 17, 2025
- We released Mistral Small 3.1 (`mistral-small-2503`).

March 6, 2025
- We released Mistral OCR (`mistral-ocr-2503`) and [document understanding](/studio/data-ingestion/document-intelligence/basic_ocr).
...
January 28, 2025
- We released custom [structured outputs](/studio/conversations/structured-output#custom-structured-output) for all models.
...
- We introduced a free API tier on Studio. 
...
- We released Agents API. See details [here](/studio/agents/introduction/).
...
Jun 5, 2024
- We released fine-tuning API. Check out the [capability docs](/resources/deprecated/finetuning) and [guides](/resources/deprecated/finetuning).

May 29, 2024
- New model available: `codestral-latest` (aka `codestral-2405`). Check out the code generation [docs](/mistral-vibe/using-fim-api).
...
- We released three versions of tokenizers for commercial and open-weight models: check the related [guide](https://github.com/mistralai/mistral-common) and [repo](https://github.com/mistralai/mistral-common) for more details.

Mar. 28, 2024
- JSON mode now available for all models on Studio. 
...
- New API capabilities:
    - [Function calling](/studio/agents/agent-tools/function-calling-api): available for Mistral Small and Mistral Large.
    - [JSON mode](/studio/conversations/structured-output#json-mode): available for Mistral Small and Mistral Large

- [Studio](https://console.snowmy.app/):
...
- A previous version of the [guardrailing documentation](/studio/safety-moderation) incorrectly referred to the API parameter as `safe_mode` instead of `safe_prompt`. We corrected this in the documentation.
