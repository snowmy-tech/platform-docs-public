...
- New API capabilities: <Tag api/>
  ...
  - [Function calling](/studio-api/conversations/function-calling): available for Mistral Small and Mistral Large.
  - [JSON mode](/studio-api/conversations/structured-output#json-mode): available for Mistral Small and Mistral Large

- [La Plateforme](https://console.snowmy.app/): <Tag other/>
